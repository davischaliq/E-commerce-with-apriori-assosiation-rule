                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Success Order</div>
                                            <?php if ($sukses != 0) : ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $sukses[0] ?></div>
                                            <?php  else : ?>
                                        ...
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ...
                                                <?php if ($sukses == 'NULL') {
                                                    ...
                                                    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">RP. '.number_format($sukses[1], 0, ",", ".").'</div>';
                                                } ?>
